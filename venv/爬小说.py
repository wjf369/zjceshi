...
class download(object):
    def __init__(self, target):
        ...
        self.__head = {'User-Agent': 'Mozilla/5.0(Macintosh; Intel Mac OS X 10_11_4)\AppleWebKit/537.36(KHTML, like Gecko) Chrome/52 .0.2743. 116 Safari/537.36' }
...
if __name__ == "__main__":
    ...
    for key, value in url_dict.items():
        ...
        sys.stdout.write( '\r'+"已下载:'%.2f'%%" % float(index / numbers) )
        sys.stdout.flush()
        index += 1
