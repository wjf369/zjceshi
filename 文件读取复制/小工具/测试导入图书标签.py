...
data = xlrd.open_workbook("C:\\Users\\sam\\Desktop\\3.xls")
...
table1 = table.row(0)  #返回由该行中所有的单元格对象组成的列表

# t1 = table.row_slice(1)  #返回由该列中所有的单元格对象组成的列表
# print(t1)
#
# t = table.row_types(0, start_colx=0, end_colx=None)    #返回由该列中所有单元格的数据类型组成的列表array('B', [2, 2, 2])
# print(t)
#
q = table.row_values(0, start_colx=0, end_colx=None)   #返回由该行中所有单元格的数据组成的列表[1607.0, 100005993.0, 100006000.0]
print(q)
print(len(q))
...
#         zhi11 = int(zhi1)
#
#         print(zhi1,type(zhi1))
#         print(zhi11,type(zhi11))
#
